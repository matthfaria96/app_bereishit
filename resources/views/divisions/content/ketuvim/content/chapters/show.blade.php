...
<table class="table">
    ...
    <tfoot>
        <tr>
            <th scope="row"></th>
            <td colspan="2"><button type="button" class="btn btn-primary create-chapter-buttom" data-bs-toggle="modal" data-bs-target="#modal-chapter">Cadastrar capítulo </button></td>
        </tr>
    </tfoot>
  </table>

    <!-- Modal -->
    <div class="modal fade" id="modal-chapter" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <form class="modal-content">
              <input type="hidden" name="_token" value="{{ csrf_token() }}" />
              <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">Números de acordo com os idiomas</h5>
...
@section('scripts')
    @include('divisions.content.ketuvim.content.chapters.scripts.show')
@endsection