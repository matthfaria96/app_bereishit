<script>
    ...
    $(document).ready(function() {
        ...
        function update(chapterId) {
            appAjax('put', `/web/ketuvim/${bookId}/chapters/${chapterId}`, getInputModalValues(), function () {
                resetForm()
        ...
        function deleteChapter(chapterId) {
            appAjax('delete', `/web/ketuvim/${bookId}/chapters/${chapterId}`, getInputModalValues(), function () {
                resetForm()
