<script>
    ...
    $(document).ready(function() {
        ...
        function update(bookId) {
            appAjax('put', `/web/torah/${bookId}`, getInputModalValues(), function () {
                resetForm()
        ...
        function deleteBook(bookId) {
            appAjax('delete', `/web/torah/${bookId}`, getInputModalValues(), function () {
                resetForm()
        ...
        function populateTable() {
            appAjax('get', '/api/torah', {}, function (data) {
                ...
                let booksHtml = data.data.map(function (item, index) {
                    return `
                        <tr>
